	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
                    Generated with <a href="http://i.shiao.org" title="Vealous">Vealous</a> by <a href="https://twitter.com/lepture">lepture</a>.Modified from <a href="http://www.arnebrachhold.de/">Arne Brachhold</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
